  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50/40 via-white to-purple-50/30 dark:from-ink-950 dark:via-ink-950 dark:to-[#0d1a2d]">
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute -left-20 top-[-10rem] h-[28rem] w-[28rem] rounded-full bg-gradient-to-br from-blue-400/25 to-cyan-300/15 blur-[100px] will-change-transform" />
        <div className="absolute right-[-4rem] top-24 h-72 w-72 rounded-full bg-gradient-to-br from-indigo-400/15 to-violet-300/10 blur-[80px] will-change-transform" />
        <div className="absolute bottom-[20%] right-[-5rem] h-[20rem] w-[20rem] rounded-full bg-gradient-to-br from-purple-400/15 to-pink-300/10 blur-[80px] will-change-transform" />
      </div>
      <a
        href="#main-content"
